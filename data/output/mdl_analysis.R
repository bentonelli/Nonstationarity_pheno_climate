...
mb1s <- MCMCsummary(model_in,params = "mu_beta1")
mb2s <- MCMCsummary(model_in,params = "mu_beta2")
mb3s <- MCMCsummary(model_in,params = "mu_beta3")
mp1s <- MCMCsummary(model_in,params = "mu_phi1")
mp2s <- MCMCsummary(model_in,params = "mu_phi2")

small_comp_list <- list(mb1s,mb2s,mb3s,mp1s,mp2s)
saveRDS(small_comp_list,"full_model_spec_params_12_6_23.rds")
